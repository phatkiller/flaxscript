...
dashd/dash-cli binaries are not included in the Flaxscript-Qt.app bundle.

If you are building `dashd` or `Flaxscript-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the Flaxscript-Qt.app
...
commands:
    ...
    echo -e "rpcuser=dashrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Flaxscript/dash.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Flaxscript/dash.conf"

When next you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/Flaxscript/debug.log
