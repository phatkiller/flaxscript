...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click flaxscript: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start flaxscript: click-to-pay handler");
    else
...
{
    // clicking on flaxscript: URLs creates FileOpen events on the Mac:
