...
{
public:
    /// Is the inputs associated with this public key? (and there is 23000 Tons of FLAX - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of flaxscript.
