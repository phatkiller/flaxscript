...
#if defined(NDEBUG)
# error "Flaxscript cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nBits, int nHeight, int64_t nFees)
{
	...
	if(nHeight == 1) {nSubsidy = 73017 * COIN;}
...
static const int64_t nInterval = 1; // Flaxscript: retarget every block
...
void ThreadScriptCheck() {
    RenameThread("flaxscript-scriptch");
