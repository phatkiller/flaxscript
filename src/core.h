...
#define START_MASTERNODE_PAYMENTS_TESTNET 1451649600 
#define START_MASTERNODE_PAYMENTS 1451649600 
...
static const int MIN_POOL_PEER_PROTO_VERSION = 90001; // minimum peer version accepted by DarkSendPool
