UNIX BUILD NOTES
====================
Some notes on how to build Flaxscript in Unix. 
...
memory available when compiling Flaxscript Core. With 512MB of memory or less
...
If you want to build Flaxscript-Qt, make sure that the required packages for Qt development
...
# Configure Flaxscript Core to use our own-built instance of BDB
cd $FLAX_ROOT
...
Security
--------
To help make your Flaxscript installation more secure by making certain attacks impossible to
