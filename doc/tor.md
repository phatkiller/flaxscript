...
It is possible to run Flaxscript as a Tor hidden service, and connect to such services.
...
The first step is running Flaxscript behind a Tor proxy. This will already make all
